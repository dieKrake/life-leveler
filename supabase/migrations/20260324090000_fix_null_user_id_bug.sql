-- Migration: Fix NULL user_id bug in check_and_update_achievements
-- Date: 2026-03-24 09:00:00
-- Description: Remove player_stats INSERT that causes NULL constraint violation.
--              Player stats should already exist when called from complete_todo.
